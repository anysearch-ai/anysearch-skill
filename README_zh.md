...
```bash
# 下载指定版本发布包（推荐）。请将 v3.0.0 替换为最新 tag
...
# 或使用：wget -O anysearch-skill.zip https://github.com/anysearch-ai/anysearch-skill/archive/refs/tags/v3.0.0.zip
# （如需获取尚未发布的最新改动，请改用 .../archive/refs/heads/main.zip。）

# 解压 —— 会生成一个名为 anysearch-skill-<ref> 的目录，例如 anysearch-skill-3.0.0
...
# 通用:            mv anysearch-skill-3.0.0 <your_agent_skill_dir>/anysearch
# 共享智能体:      mv anysearch-skill-3.0.0 ~/.agents/skills/anysearch
```
