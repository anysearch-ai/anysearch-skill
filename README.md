...
```bash
# Download a pinned release (recommended). Replace v3.0.0 with the latest tag
# from https://github.com/anysearch-ai/anysearch-skill/releases
curl -L -o anysearch-skill.zip https://github.com/anysearch-ai/anysearch-skill/archive/refs/tags/v3.0.0.zip
# or: wget -O anysearch-skill.zip https://github.com/anysearch-ai/anysearch-skill/archive/refs/tags/v3.0.0.zip
# (For the latest unreleased changes, use .../archive/refs/heads/main.zip instead.)

# Unzip — creates a directory named anysearch-skill-<ref>, e.g. anysearch-skill-3.0.0
...
# Claude Code:     mv anysearch-skill-3.0.0 ~/.claude/skills/anysearch
# OpenCode:        mv anysearch-skill-3.0.0 ~/.config/opencode/skills/anysearch
# Cursor/Windsurf: mv anysearch-skill-3.0.0 <project>/.skills/anysearch
# Generic:         mv anysearch-skill-3.0.0 <your_agent_skill_dir>/anysearch
# Shared agents:   mv anysearch-skill-3.0.0 ~/.agents/skills/anysearch
```
